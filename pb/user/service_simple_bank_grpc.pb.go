...
const (
	SimpleBank_CreateUser_FullMethodName  = "/user.SimpleBank/CreateUser"
	SimpleBank_UpdateUser_FullMethodName  = "/user.SimpleBank/UpdateUser"
	SimpleBank_LoginUser_FullMethodName   = "/user.SimpleBank/LoginUser"
	SimpleBank_VerifyEmail_FullMethodName = "/user.SimpleBank/VerifyEmail"
)
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "user/service_simple_bank.proto",
}
